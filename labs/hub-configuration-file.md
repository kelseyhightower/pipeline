...
In this section you will generate a [hub configuration file](https://hub.github.com/hub.1.html#CONFIGURATION) to hold the GitHub credentials generated in the [prerequisites lab](prerequisites.md). The hub configuration file is used by the `hub` command line utility when automating GitHub related tasks.
